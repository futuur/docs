...
```
GET https://api.futuur.com/v2.0/wagers/
```
...
```bash cURL
curl --request GET \
  --url "https://api.futuur.com/v2.0/wagers/?active=true&currency_mode=real_money&limit=2" \
...
```json Sample response
{
  "pagination": {
    "total": 12,
    "next": "https://api.futuur.com/v2.0/wagers/?active=true&currency_mode=real_money&limit=2&offset=2",
    "previous": null,
    "page_size": 2,
    "offset": 0
  },
  "results": [
    {
      ...
      "user": "https://api.futuur.com/v2.0/users/5042/",
      "event": "https://api.futuur.com/v2.0/events/901/",
      "market": "https://api.futuur.com/v2.0/markets/3801/",
      "position": "long",
