---
title: 'Event actions'
description: 'List all trading actions (bets) for a specific event.'
---

Retrieve a list of all trading actions (wager actions) that have occurred on an event. Real money actions have user information anonymized.
