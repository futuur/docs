...
Retrieve a list of prediction market events. Use query parameters to filter by category, currency mode, tags, search terms, and more.
...
<ParamField query="hide_my_bets" type="boolean" default="false">
  When `true`, excludes events where you have active positions.
</ParamField>
...
{
  "count": 150,
  "next": "https://api.futuur.com/v2.0/events/?currency_mode=play_money&limit=10&offset=10",
  "previous": null,
  "results": [
    {
      "id": 1234,
