...
Every authenticated request requires HMAC-SHA512 authentication using a public/private key pair. [Get your API keys](/guides/get-api-keys) from **Settings** → **API keys**, then see [Authentication](/authentication) for the signing process.
...
<CardGroup cols={2}>
  ...
  <Card title="Realtime (websockets)" icon="radio" href="/api-reference/websocket/overview">
