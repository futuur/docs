...
<Note>
  All examples use the base URL `https://api.futuur.com`. Every request requires HMAC authentication headers. See [Get your API keys](/guides/get-api-keys) and the [Authentication](/authentication) guide for how to generate them.
</Note>
