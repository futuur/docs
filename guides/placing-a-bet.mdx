...
<Note>
  All examples use `https://api.futuur.com/v2.0`. Authenticated requests require HMAC headers. See the [Authentication](/authentication) guide for how to generate them.
</Note>
