...
The [Model Context Protocol](https://modelcontextprotocol.io) (MCP) lets AI assistants like Claude call external tools on your behalf. The Futuur MCP server exposes 19 tools covering market discovery, order placement, position management, and account info — all accessible through natural language.
...
[Smithery](https://smithery.ai/server/@futuur/futuur-mcp) is a one-command MCP installer. It will prompt you for your keys and write the config automatically.
...
Restart your client after running this. Done.

---

## Option 2 — Manual config

Paste your keys below to generate a ready-to-copy config for your client.
    ...
    <div style={{ border: '1px solid #e5e7eb', borderRadius: '12px', padding: '20px', marginBottom: '24px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
        <div>
          ...
          <input style={inputStyle} value={pub} onChange={e => setPub(e.target.value)} placeholder="pk_live_..." spellCheck={false} />
        </div>
        <div>
          <label style={labelStyle}>Private key</label>
          <input style={inputStyle} type="password" value={priv} onChange={e => setPriv(e.target.value)} placeholder="sk_live_..." spellCheck={false} />
        </div>
      </div>
      ...
      <div>
        ...
        <div style={blockStyle}>
          ...
          <button style={copyBtnStyle} onClick={() => copy(claudeDesktopConfig, 'desktop')}>
      ...
      <div>
        ...
        <div style={blockStyle}>
          <pre style={preStyle}>{claudeCodeConfig}</pre>
          <button style={copyBtnStyle} onClick={() => copy(claudeCodeConfig, 'code')}>
      ...
      <div>
        ...
        <div style={blockStyle}>
          <pre style={preStyle}>{cursorConfig}</pre>
          <button style={copyBtnStyle} onClick={() => copy(cursorConfig, 'cursor')}>
...
Here's a typical flow using natural language:
...
<CardGroup cols={2}>
  ...
  <Card title="Smithery listing" icon="box" href="https://smithery.ai/server/@futuur/futuur-mcp">
